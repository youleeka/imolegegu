...
public class PullToRefreshListView extends SwipeRefreshLayout
		implements
			OnScrollListener {
	private static final String TAG = PullToRefreshListView.class
			.getSimpleName();
	/**
	 * 列表视图
	 */
	...
	public PullToRefreshListView(Context context, AttributeSet attrs) {
		...
		mPullLoadEnable = a.getBoolean(R.styleable.PullToRefresh_isLoadEnable,
				true);
		mDrawable = a.getDrawable(R.styleable.PullToRefresh_dividerBackground);
		a.recycle();
	...
	private void init(Context context) {
		...
		mListView.setDivider(mDrawable);
		// 设置是否支持下拉刷新
	...
	public void setHasMoreData(boolean hasMoreData) {
		...
		if (!hasMoreData) {
			setFooterState(false, "全部数据,已经加载完成");
		}
	}
	/**
	 * 刷新完成
